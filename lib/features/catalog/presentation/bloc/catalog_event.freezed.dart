...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( CatalogLoadEvent value)?  load,required TResult orElse(),}){
final _that = this;
switch (_that) {
case CatalogLoadEvent() when load != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( CatalogLoadEvent value)  load,}){
final _that = this;
switch (_that) {
case CatalogLoadEvent():
return load(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( CatalogLoadEvent value)?  load,}){
final _that = this;
switch (_that) {
case CatalogLoadEvent() when load != null:
return load(_that);case _:
...
class CatalogLoadEvent implements CatalogEvent {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CatalogLoadEvent);
}
