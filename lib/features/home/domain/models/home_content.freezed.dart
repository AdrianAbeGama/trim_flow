...
class _HomeContent implements HomeContent {
  const _HomeContent({this.heroTitle = 'TrimFlow Premium Studio', this.heroSubtitle = 'Donde el estilo se encuentra con la precisión.', this.heroImageUrl = 'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=800', this.heroTag1 = 'DREAM FLOW ELITE', this.heroTag2 = 'PREMIUM STUDIO', final  List<Map<String, String>> stories = const [], final  List<Map<String, String>> services = const [], final  List<Map<String, String>> products = const [], this.aboutUsTitle = 'Sobre Nosotros', this.aboutUsText = 'Pasión por el detalle, respeto por la tradición y compromiso con tu estilo. Bienvenido a la experiencia Trimflow.', this.aboutUsImageUrl = 'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=800', this.aboutUsVideoUrl = '', final  Map<String, String> socialLinks = const {'instagram' : '', 'tiktok' : '', 'whatsapp' : '', 'facebook' : ''}, final  List<Map<String, String>> locations = const [{'label' : 'Sede Central', 'address' : 'CALLE PRINCIPAL 123, AREQUIPA', 'mapUrl' : 'https://maps.google.com'}, {'label' : 'Sede Yanahuara', 'address' : 'AV. EJÉRCITO 456, AREQUIPA', 'mapUrl' : 'https://maps.google.com'}]}): _stories = stories,_services = services,_products = products,_socialLinks = socialLinks,_locations = locations;
