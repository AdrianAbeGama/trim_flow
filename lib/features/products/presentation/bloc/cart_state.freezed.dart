...
class CartStateData extends CartState {
  const CartStateData({final  List<CartItem> items = const <CartItem>[]}): _items = items,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CartStateData&&const DeepCollectionEquality().equals(other._items, _items));
}
