...
mixin _$Service {
 ...
 String get tenantId; String get id; String get name; double get price; int get durationInMinutes; String get category; bool get isFeatured;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,tenantId,id,name,price,durationInMinutes,category,isFeatured);

@override
String toString() {
  return 'Service(tenantId: $tenantId, id: $id, name: $name, price: $price, durationInMinutes: $durationInMinutes, category: $category, isFeatured: $isFeatured)';
}
...
@useResult
$Res call({
 String tenantId, String id, String name, double price, int durationInMinutes, String category, bool isFeatured
});
...
/// Create a copy of Service
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? tenantId = null,Object? id = null,Object? name = null,Object? price = null,Object? durationInMinutes = null,Object? category = null,Object? isFeatured = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String tenantId,  String id,  String name,  double price,  int durationInMinutes,  String category,  bool isFeatured)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Service() when $default != null:
return $default(_that.tenantId,_that.id,_that.name,_that.price,_that.durationInMinutes,_that.category,_that.isFeatured);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String tenantId,  String id,  String name,  double price,  int durationInMinutes,  String category,  bool isFeatured)  $default,) {final _that = this;
switch (_that) {
case _Service():
return $default(_that.tenantId,_that.id,_that.name,_that.price,_that.durationInMinutes,_that.category,_that.isFeatured);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String tenantId,  String id,  String name,  double price,  int durationInMinutes,  String category,  bool isFeatured)?  $default,) {final _that = this;
switch (_that) {
case _Service() when $default != null:
return $default(_that.tenantId,_that.id,_that.name,_that.price,_that.durationInMinutes,_that.category,_that.isFeatured);case _:
  return null;
...
class _Service implements Service {
  const _Service({required this.tenantId, required this.id, required this.name, required this.price, required this.durationInMinutes, required this.category, this.isFeatured = false});
...
/// Create a copy of Service
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? tenantId = null,Object? id = null,Object? name = null,Object? price = null,Object? durationInMinutes = null,Object? category = null,Object? isFeatured = null,}) {
