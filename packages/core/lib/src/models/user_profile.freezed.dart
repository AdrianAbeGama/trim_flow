...
mixin _$UserProfile {
 ...
 String get tenantId; String get id; String get firstName; String get lastName; String get email; String get photoUrl; String get phone; String get birthDate; bool get notificationsEnabled; String? get customerId; String? get barberId; String? get branchId; int get completedCuts; List<CuttingRecord> get history;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,tenantId,id,firstName,lastName,email,photoUrl,phone,birthDate,notificationsEnabled,customerId,barberId,branchId,completedCuts,const DeepCollectionEquality().hash(history));

@override
String toString() {
  return 'UserProfile(tenantId: $tenantId, id: $id, firstName: $firstName, lastName: $lastName, email: $email, photoUrl: $photoUrl, phone: $phone, birthDate: $birthDate, notificationsEnabled: $notificationsEnabled, customerId: $customerId, barberId: $barberId, branchId: $branchId, completedCuts: $completedCuts, history: $history)';
}
...
@useResult
$Res call({
 String tenantId, String id, String firstName, String lastName, String email, String photoUrl, String phone, String birthDate, bool notificationsEnabled, String? customerId, String? barberId, String? branchId, int completedCuts, List<CuttingRecord> history
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String tenantId,  String id,  String firstName,  String lastName,  String email,  String photoUrl,  String phone,  String birthDate,  bool notificationsEnabled,  String? customerId,  String? barberId,  String? branchId,  int completedCuts,  List<CuttingRecord> history)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserProfile() when $default != null:
return $default(_that.tenantId,_that.id,_that.firstName,_that.lastName,_that.email,_that.photoUrl,_that.phone,_that.birthDate,_that.notificationsEnabled,_that.customerId,_that.barberId,_that.branchId,_that.completedCuts,_that.history);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String tenantId,  String id,  String firstName,  String lastName,  String email,  String photoUrl,  String phone,  String birthDate,  bool notificationsEnabled,  String? customerId,  String? barberId,  String? branchId,  int completedCuts,  List<CuttingRecord> history)  $default,) {final _that = this;
switch (_that) {
case _UserProfile():
return $default(_that.tenantId,_that.id,_that.firstName,_that.lastName,_that.email,_that.photoUrl,_that.phone,_that.birthDate,_that.notificationsEnabled,_that.customerId,_that.barberId,_that.branchId,_that.completedCuts,_that.history);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String tenantId,  String id,  String firstName,  String lastName,  String email,  String photoUrl,  String phone,  String birthDate,  bool notificationsEnabled,  String? customerId,  String? barberId,  String? branchId,  int completedCuts,  List<CuttingRecord> history)?  $default,) {final _that = this;
switch (_that) {
case _UserProfile() when $default != null:
return $default(_that.tenantId,_that.id,_that.firstName,_that.lastName,_that.email,_that.photoUrl,_that.phone,_that.birthDate,_that.notificationsEnabled,_that.customerId,_that.barberId,_that.branchId,_that.completedCuts,_that.history);case _:
  return null;
...
class _UserProfile implements UserProfile {
  const _UserProfile({required this.tenantId, required this.id, required this.firstName, required this.lastName, required this.email, required this.photoUrl, required this.phone, required this.birthDate, required this.notificationsEnabled, this.customerId, this.barberId, this.branchId, this.completedCuts = 2, final  List<CuttingRecord> history = const []}): _history = history;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,tenantId,id,firstName,lastName,email,photoUrl,phone,birthDate,notificationsEnabled,customerId,barberId,branchId,completedCuts,const DeepCollectionEquality().hash(_history));
